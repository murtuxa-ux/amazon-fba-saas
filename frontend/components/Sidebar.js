...
const NAV = [
  ...
  { href: "/ppc",               label: "PPC Action Plan", icon: "\u25C9", section: "ops"  },
  { href: "/ppc-advanced",      label: "PPC Advanced",    icon: "\u25CE", section: "ops"  },
  { href: "/inventory",         label: "Inventory",       icon: "\u25A3", section: "ops"  },
  { href: "/wholesale",         label: "Wholesale Hub",   icon: "\u25D0", section: "ops"  },
  { href: "/private-label",     label: "Private Label",   icon: "\u25C8", section: "ops"  },
  ...
  { href: "/ai-tools",          label: "AI Tools",        icon: "\u2726", section: "ai"  },
  { href: "/team",              label: "Team",            icon: "\u25CB", section: "ai"  },
  { href: "/workflow",          label: "Workflow",        icon: "\u25A7", section: "tools" },
  { href: "/client-portal",     label: "Client Portal",  icon: "\u25A0", section: "tools" },
  { href: "/finance",           label: "Finance & P&L",  icon: "\u25B3", section: "tools" },
  { href: "/reporting",         label: "Reporting",       icon: "\u25A4", section: "tools" },
  ...
  { href: "/amazon-settings",    label: "Amazon API",    icon: "\u25CF", section: "config" },
];
