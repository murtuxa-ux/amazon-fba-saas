...
# Phase 7-11: New modules
from products_manager import router as products_pipeline_router
from purchase_orders import router as purchase_orders_router
from client_pnl import router as client_pnl_router
from automation_service import router as automation_router
from client_portal import router as client_portal_router
from intelligence_hub import router as intelligence_router
...
# Phase 7-11 routers
app.include_router(products_pipeline_router)
app.include_router(purchase_orders_router)
app.include_router(client_pnl_router)
