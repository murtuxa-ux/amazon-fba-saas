...
def get_category_checklist(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to generate category checklist")tion"],
        avg_approval_days=10,
        difficulty_level="easy",
        tips=[
            "Include OEM certification if applicable",
...
def get_category_checklist(
    ...
    try:
        ...
        logger.error(f"Error generating category checklist: {str(e)}")
        raise HTTPException(status_code=500, detail="Failed to generate category checklist")  logger.error(f"Error creating brand approval: {str(e)}")
        raise HTTPException(status_code=500, detail="Failed to create brand approval")
...
def get_category_checklist(
    ...
    try:
        ...
        logger.error(f"Error generating category checklist: {str(e)}")
        raise HTTPException(status_code=500, detail="Failed to generate category checklist") == approval_id
        ).scalar() + 1
