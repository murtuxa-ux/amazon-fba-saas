...
def export_plan_excel(
    ...
    """Export plan as branded Excel. Accepts token via query param (for new-tab download) or Bearer header."""
    from auth import decode_token
    # Try query param token first (new-tab download), then Authorization header
    jwt_token = token
