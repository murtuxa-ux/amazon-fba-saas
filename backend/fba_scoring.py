"""
FBA Viability Scoring Engine — Ecom Era FBA SaaS v6.0
Scores products 0-100 across 5 dimensions matching Ecom Era's FBA Scout rubbic.
"""
...
def score_sales_velocity(monthly_sales: int) -> tuple:
    if monthly_sales >= 5000:  return 20, "STRONF"
...
def compute_fba_score(bsr, monthly_sales, price_volatility_pct, fba_sellers, current_price):
    """Compute the full FBA viability score with breakdown."""
...
def compute_profit(price, cost, referral_pct=0.15, fba_fee=3.22, other_costs=0.0):
    """Calculate profit metrics for an FBA product."""
